...
def print_spiciest_foods(spicy_foods)
  greater_then_five_spicy_foods = spiciest_foods(spicy_foods)
  print_spicy_foods(greater_then_five_spicy_foods)
end

# given an array of spicy foods, return an integer representing 
# the average heat level of all the spicy foods in the array
def average_heat_level(spicy_foods)
  heat_level_array = spicy_foods.map {|spicy_food| spicy_food[:heat_level]}
  reduced_array = heat_level_array.reduce {|num1, num2| num1 + num2}
  reduced_array/spicy_foods.length
end
